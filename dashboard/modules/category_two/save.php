      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <h4 class="text-center"><?php echo $title ?></h4> <br>
            ...
            <ul>
              <li><small>Dimensiones de 1200 x 1262 pixeles en formato JPG o PNG</small></li>
           ...
           ?>
            ...
            <br>
            <small> Selecciona un archivo PDF que contenga toda la información de el destino</small>
            ...
            <div class="form-group">
            <input type="submit" class="btn btn-default btn-custom" value="Guardar Destino">
            </div>  
